...
#define PARM_FILEPATH taskgraph/task/##PARM_NODE_CLASS##.parm.h
#endif

#define RTTR_NAME tasklab::##PARM_NODE_NAME

rttr::registration::class_<tasklab::node::PARM_NODE_CLASS>(XSTR(RTTR_NAME))
.constructor<>()

#define PARAM_INFO(id, type, name, member, default_val)        \
.property(#name, &tasklab::node::##PARM_NODE_CLASS::member)        \
(                                                              \
